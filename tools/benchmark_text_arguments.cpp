...
template <typename Consume> double benchmark(int iterations, Consume consume, size_t& checksum) {
...
int main(int argc, char** argv) {
    ...
    std::cout << std::fixed << std::setprecision(3) << "iterations=" << iterations << " string_ms=" << stringMs
