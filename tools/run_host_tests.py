...
CPP_TESTS = [
    ...
    "content_completion_coordinator_test.cpp",
    "deep_link_test.cpp",
    ...
    "playback_continuation_executor_test.cpp",
    "playback_coordinator_test.cpp",
    "playback_profile_test.cpp",
    "playback_resolution_executor_test.cpp",
    "playback_resolver_test.cpp",
    "playback_session_test.cpp",
    "playback_stream_executor_test.cpp",
    ...
    "similar_prefetch_controller_test.cpp",
