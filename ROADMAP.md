...
- [~] **LAN discovery:** app support is implemented, but Test Server currently drops LAN UDP 7359. Distinct-user switching, Quick Connect, saved-profile lifecycle/expiry cleanup and saved-server endpoint switching are physically verified.
