...
- 2026-09-04: HDR10 acceptance found an audio-transcode regression: the HEVC Main 10 source was
  ...
  still blocked until Test Server has the installed production signing key rather than the temporary
  bughunt identity.
...
- 2026-09-04: the production-signed streamer install exposed overlapping Search result metadata.
  ...
  fix is blocked non-destructively because Test Server currently points at a temporary Bughunt signing
