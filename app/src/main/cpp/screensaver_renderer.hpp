...
template <typename ColorLike> struct ScreensaverRenderStyle {
...
void renderScreensaverScreen(RendererLike& renderer, int64_t elapsedSeconds, std::string_view clock, float canvasWidth,
                             float canvasHeight, const ScreensaverRenderStyle<ColorLike>& style,
    ...
    drawCentered(600.0f, 1008.0f, 720.0f, 48.0f, 1.45f, "Press any button to return", style.tertiary, 12.0f, 4.0f);
}
