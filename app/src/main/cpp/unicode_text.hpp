...
inline void appendDisplayCodePoint(std::string& output, uint32_t codePoint, char unsupported = '?') {
    ...
    if ((codePoint >= 0x0300 && codePoint <= 0x036F) || (codePoint >= 0x1AB0 && codePoint <= 0x1AFF) ||
        (codePoint >= 0x1DC0 && codePoint <= 0x1DFF) || (codePoint >= 0xFE00 && codePoint <= 0xFE0F) ||
        (codePoint >= 0xFE20 && codePoint <= 0xFE2F)) {
        return;
    }
    if (codePoint == 0x00AD || (codePoint >= 0x200B && codePoint <= 0x200F) ||
        (codePoint >= 0x202A && codePoint <= 0x202E) || codePoint == 0x2060 ||
        (codePoint >= 0x2066 && codePoint <= 0x2069) || codePoint == 0xFEFF) {
        return;
    }
    if (codePoint == 0x00A0 || (codePoint >= 0x2000 && codePoint <= 0x200A) || codePoint == 0x202F ||
