...
inline constexpr std::array<SettingDescriptor, kSettingCount> kSettingDescriptors{{
    ...
    {SettingId::SeerrServer, "SEERR SERVER", 9, kNoSettingOrder, SettingKind::Action, SettingChangeEffect::None,
     nullptr, renderSeerrServer, SettingActivation::EditSeerrServer},
