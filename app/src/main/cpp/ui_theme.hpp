...
inline constexpr Color background{0.047f, 0.051f, 0.059f, 1.0f};
inline constexpr Color surface{0.067f, 0.071f, 0.082f, 0.98f};
inline constexpr Color surfaceContainer{0.098f, 0.106f, 0.122f, 1.0f};
inline constexpr Color surfaceContainerHigh{0.137f, 0.145f, 0.165f, 1.0f};
inline constexpr Color surfaceContainerHighest{0.176f, 0.188f, 0.212f, 1.0f};
...
inline constexpr Color primaryContainer{0.157f, 0.235f, 0.329f, 1.0f};
