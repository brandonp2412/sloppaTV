    ...
    for (std::size_t i = 0; i < controlWidths.size(); ++i) {
        ...
        if (i == 0 || i == 2) {
            ...
            renderer.triangle(iconX + 8.0f, iconCenterY - 8.0f, iconX + 8.0f, iconCenterY + 8.0f, iconX + 20.0f,
                              iconCenterY, style.text);
            renderer.roundedRect(iconX + 25.0f, iconCenterY - 8.0f, 3.0f, 16.0f, 1.5f, style.text);
            renderer.roundedRect(iconX + 32.0f, iconCenterY - 13.0f, 3.0f, 26.0f, 1.5f, style.text);
            ...
            renderer.roundedRect(iconX + 7.0f, iconCenterY + 3.0f, 14.0f, 3.0f, 1.5f, style.text);
            renderer.roundedRect(iconX + 25.0f, iconCenterY + 3.0f, 6.0f, 3.0f, 1.5f, style.text);
            renderer.textVerticallyCentered(iconX + iconWidth + gap, bounds[1], bounds[3], labelScale, label,
                                            style.text);
        }
