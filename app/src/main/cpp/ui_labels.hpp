...
inline std::string_view materialLabel(std::string_view value) {
    static constexpr std::pair<std::string_view, std::string_view> labels[]{
        ...
        {"SEERR CONNECTION", "Seerr connection"},
        {"SEERR DRIVE SELECTION", "Seerr drive selection"},
        {"SEERR API KEY", "Seerr API key"},
        {"SEERR API KEY (LEGACY)", "Seerr API key (legacy)"},
        {"CONNECTED", "Connected"},
        {"CONNECT WITH JELLYFIN", "Connect with Jellyfin"},
        {"LEGACY API KEY", "Legacy API key"},
        {"NOT SET", "Not set"},
        {"SET", "Set"},
